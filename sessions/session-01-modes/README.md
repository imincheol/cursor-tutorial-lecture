...
- ✅ Agent Review 탭 (AI 코드 리뷰) + **실습 4** 체험
- ✅ Past Chat 참조 (이전 대화 재사용) + **실습 5** 체험
...
[2장: Rules - AI에게 지침 주기](../session-02-rules/README.md)
