# 8장: Agent Skills & Sub-Agent (보충 자료)

> **Nightly 빌드의 실험적 기능을 미리 살펴봅니다**

## 📝 개요

이 장은 **보충 자료**입니다. 시간 여유가 있을 때 학습하시면 됩니다.

Cursor Nightly 빌드에서 실험 중인 **Agent Skills**와 **Sub-Agent** 기능을 미리 살펴보고, 현재 Hooks와 Multi-Agent로 유사한 패턴을 구현하는 방법을 배웁니다.
...
```
현재 할 수 있는 것:
1. Worktree Multi-Agent 익숙해지기 (7장)
2. Role 기반 작업 분리 연습
3. 오케스트레이션 개념 이해 (9장)
...
- [7장: Multi-Agent](../session-07/README.md)
- [9장: Orchestration](../session-09/README.md)
