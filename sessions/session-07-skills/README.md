...
8장에서는 **Subagents**를 배웁니다. Agent가 복잡한 작업을 자동으로 여러 하위 에이전트에게 분배하여 처리하는 방법을 알아봅니다.

---

## ⏭ 다음 장

[8장: Subagents - 자동 오케스트레이션](../session-08-subagents/README.md)
